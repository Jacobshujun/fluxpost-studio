...
Invoke-NativeStep "Weibo image cleanup check" $nodePath @("scripts/harness/weibo_image_cleanup_check.mjs")
...
Invoke-NativeStep "Video download fallback check" $nodePath @("scripts/harness/video_download_fallback_check.mjs")
Invoke-NativeStep "Video frame policy check" $nodePath @("scripts/harness/video_frame_policy_check.mjs")
Invoke-NativeStep "Video quality selection check" $nodePath @("scripts/harness/video_quality_selection_check.mjs")
Invoke-NativeStep "Video frame original-reference check" $nodePath @("scripts/harness/video_frame_original_reference_check.mjs")
Invoke-NativeStep "Video transcription check" $nodePath @("scripts/harness/video_transcription_check.mjs")
...
Invoke-NativeStep "Feishu vehicle options check" $nodePath @("scripts/harness/feishu_vehicle_options_check.mjs")
...
Invoke-NativeStep "Source import retirement check" $nodePath @("scripts/harness/source_import_feishu_check.mjs")
...
Invoke-NativeStep "User text instruction priority check" $nodePath @("scripts/harness/user_text_instruction_priority_check.mjs")
...
Invoke-NativeStep "Simple viral run check" $nodePath @("scripts/harness/simple_viral_run_check.mjs")
Invoke-NativeStep "Simple original run check" $nodePath @("scripts/harness/simple_original_run_check.mjs")
Invoke-NativeStep "Viral replication regression check" $nodePath @("scripts/harness/viral_replication_regression_check.mjs")
...
Invoke-NativeStep "Material library preview check" $nodePath @("scripts/harness/material_library_preview_check.mjs")
Invoke-NativeStep "Review preview layout check" $nodePath @("scripts/harness/review_preview_layout_check.mjs")
Invoke-NativeStep "Image task fallback check" $nodePath @("scripts/harness/image_task_fallback_check.mjs")
Invoke-NativeStep "GPT image size request check" $nodePath @("scripts/harness/gpt_image_size_request_check.mjs")
