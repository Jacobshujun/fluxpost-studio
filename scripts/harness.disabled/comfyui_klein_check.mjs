...
assertContains(page, /const simpleUseComfyUiKlein = simpleUseComfyUiKleinOverride \?\? comfyUiKleinAvailable/, "Simple Klein switch must be clickable while defaulting from config availability.");
