...
assertContains(sourceImportFeishu, /dongchedi.*ugc\/article\/\$\{sourceId\}/s, "Source-import Feishu sync should canonicalize Dongchedi links.");
assertContains(sourceImportFeishu, /dongchedi:\s*"\\u61c2\\u8f66\\u5e1d"/, "Source-import Feishu sync should label Dongchedi records.");
...
assertContains(checkPs1, /Dongchedi import check/, "Harness baseline must include the Dongchedi import check.");
