...
const sourceImportFeishu = read("src/lib/source-import-feishu.ts");
...
assertContains(sourceImportFeishu, /bbs\.xiaopeng\.com\/thread\/\$\{sourceId\}\?tidType=1/, "Source-import Feishu sync should canonicalize Xiaopeng BBS links.");
assertContains(sourceImportFeishu, /xiaopeng_bbs:\s*"小鹏社区"/, "Source-import Feishu sync should label Xiaopeng BBS records.");
...
assertContains(checkPs1, /Xiaopeng BBS import check/, "Harness baseline must include the Xiaopeng BBS import check.");
