...
- [x] Run the focused library-assets, copy-library, Canvas, and VPS deployment checks for the existing candidate.
- [ ] Run focused legacy-material retirement, local-build-output, Canvas scheduler/workflow/concurrency, and VPS deployment checks after the expanded port.
