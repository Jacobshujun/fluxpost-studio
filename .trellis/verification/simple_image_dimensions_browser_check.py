...
async def check(browser, width):
    ...
    for control in [ratio, resolution]:
    ...
    await page.close()
    print(f"Simple dimension selects passed at {width}px: legacy prompt, supported options, save/reload, request payload and layout")
