...
has(page, /onPreviewAsset=\{\(asset\) => openImageGallery\(\[asset\.path\], 0, asset\.name, asset\.path\)\}/, "Material asset preview action should open the image gallery with the asset path.");
