...
try {
  ...
  for (const name of ["types", "node-utils", "source-video-contract", "video-loader", "content-collection", "save-images", "seedance-references", "subtitle-style", "subtitle-editor", "registry", "graph", "serialization", "clipboard", "workflow-file"]) {
