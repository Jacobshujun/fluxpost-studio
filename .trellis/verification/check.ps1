...
Invoke-NativeStep "Source video reference check" $nodePath @(".trellis/verification/source_video_reference_check.mjs")
...
Invoke-NativeStep "Content desk check" $nodePath @(".trellis/verification/content_desk_check.mjs")
...
Invoke-NativeStep "Image generation toggle check" $nodePath @(".trellis/verification/image_generation_toggle_check.mjs")
