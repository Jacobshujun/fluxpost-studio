...
assertContains(contentPage, /crawlEnableVideoTranscription/, "/content keyword crawl UI must keep video transcription switch state.");
assertContains(contentPage, /linkImportEnableVideoTranscription/, "/content link import UI must keep video transcription switch state.");
...
assertContains(contentPage, /enableVideoTranscription:\s*crawlEnableVideoTranscription/, "/content keyword crawl request must send the video transcription switch.");
assertContains(contentPage, /enableVideoTranscription:\s*linkImportEnableVideoTranscription/, "/content link import request must send the video transcription switch.");
...
assertContains(baseline, /video_transcription_check\.mjs/, "Trellis baseline must include the video transcription check.");
