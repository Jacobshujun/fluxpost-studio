...
- 2026-08-14: Exact SHA `39a35f8dd869d50df9008ba708e14b92eeefc761` passed save-images/Edge and full local/VPS checks, then deployed as `20260814-085108-39a35f8dd869` after zero-work preflight and a validated 5,522,879-byte backup. Identity, health, HTTP/auth, workers, 15 tables, seven volumes, protected services, retention/timer, logs, and rollback `20260814-055428-669a3272f764` passed without external writes; full evidence is in the release task.
- 2026-08-14: Exact SHA `669a3272f764a05f994b87875ff6a9fc8df78675` passed batch-copy regressions and complete local/VPS baselines, then deployed as `20260814-055428-669a3272f764` after zero-work preflight and a validated 5,472,393-byte backup. Identity, health, routes/auth, workers, 15 required tables, seven volumes, protected services, retention/timer, logs, and rollback release `20260814-025955-5be0cb988580` passed without external writes; full evidence is in the release task.
