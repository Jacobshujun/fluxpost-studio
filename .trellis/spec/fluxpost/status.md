...
Production 38 serves the Canvas image-preview middle-mouse isolation fix at exact SHA `fedceccfda93401cc1539df034dbd1833647b4a3` as release `20260804-023054-fedceccfda93`; deployment and post-deploy verification passed.

## Current Focus

- Production 38 runs exact SHA `fedceccfda93401cc1539df034dbd1833647b4a3`; hosts 82 and 104 remain retired. Canvas image preview now owns wheel zoom without delayed native scrolling and blocks middle-button auto-scroll while preserving the underlying Canvas zoom behavior.
